...
### Step 10. Cleaning Up
- In our case cleaning up activity includes only deleting the previously created S3 bucket content (making it empty)from the previous successful pipeline.
